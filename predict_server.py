...
app = Flask(__name__)
model = pickle.load(open("flight_fare.pickle", "rb"))
...
def predict():
    if request.method == "POST":
        ...
        # Date_of_Journey
        date_dep = request.form.get("Dep_time", datetime.datetime(2022, 10, 16, 1, 51))
        ...
        # Arrival
        date_arr = request.form.get("Arrival_Time", datetime.datetime(2022, 10, 17, 3, 23))
        ...
        Duration_min = abs(Arrival_Time_min - Dep_Time_min)

        # Total Stops
        Total_stops = int(request.form.get("stops", False))

        # Airline
        # AIR ASIA = 0 (not in column)
        airline = request.form.get('airline', False)
